...
<div class="heading" style="display: flex;">
        <p class="h1 text-warning text-center" style="margin: auto;"><i style="color:beige;">Users :-</i><span class="text-primary"><i style="color:beige;"><?php echo "  ".$users; ?> </i></span></p>
    </div>
    <br>
    ...
    <div class="heading" style="display: flex;">
        <p class="h1 text-warning text-center" style="margin: auto;"><i style="color:beige;">Unregister Student(Admin side):-</span></p>
    </div>
    <br>
    <div class="topic" id="topic">
        <table class="table table-hover">
            <thead>
                ...
                <th scope="col"><i>Email</i></th>
                <th scope="col"><i>Role</i></th>
                <th scope="col"><i>Temporary Password</i></th>
                <th  style="min-width:50px; width:10%;"><i>Action</i></th>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="heading" style="display: flex;">
        <p class="h1 text-warning text-center" style="margin: auto;"><i style="color:beige;">Unregister Teacher(Admin side):-</i><span class="text-primary"></span></p>
    </div>
    <br>
    <div class="topic" id="topic">
        <table class="table table-hover">
