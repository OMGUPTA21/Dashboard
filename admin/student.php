...
<div class="heading" style="display: flex;">
        <p class="h1 text-warning text-center" style="margin: auto;"><i style="color:beige;">Students :</i><span class="text-primary"><i style="color:beige;"><?php echo $users;?></i></span></p>
    </div>
